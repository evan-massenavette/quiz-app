  ...
  <v-container>
    <v-form v-model="form" @submit.prevent="$emit('edited', question)">
      ...
      <v-card-text>
        ...
        <v-text-field prepend-icon="mdi-form-textbox" type="text" label="Answer 1" clearable
          placeholder="Enter the answer" :rules="[required]" :disabled="loading"
          v-model="question.possibleAnswers[0].text" />
        <v-text-field prepend-icon="mdi-form-textbox" type="text" label="Answer 2" clearable
          placeholder="Enter the answer" :rules="[required]" :disabled="loading"
          v-model="question.possibleAnswers[1].text" />
        <v-text-field prepend-icon="mdi-form-textbox" type="text" label="Answer 3" clearable
          placeholder="Enter the answer" :rules="[required]" :disabled="loading"
          v-model="question.possibleAnswers[2].text" />
        <v-text-field prepend-icon="mdi-form-textbox" type="text" label="Answer 4" clearable
          placeholder="Enter the answer" :rules="[required]" :disabled="loading"
